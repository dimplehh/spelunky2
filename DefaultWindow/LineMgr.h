...
public:
	...
	bool		Collision_MonsterLine(float& fX, float& fY, float fCX, float fCY);
	bool		Collision_Olmec_Line(float& fX, float& fY, float fCX, float fCY);
	float		Collision_LineY(float& fX, float& fY, float fCX, float fCY);
