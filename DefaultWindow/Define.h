...
enum OBJID { OBJ_BOX, OBJ_ROPE, OBJ_CHEST, OBJ_OBSTACLE, OBJ_ITEM, OBJ_PLAYER, OBJ_HOLDOBJ, OBJ_MONSTER, OBJ_BOMB, OBJ_UI, OBJ_END };
enum RENDERID { RENDER_BACKGROUND, RENDER_GAMEOBJECT, RENDER_TILE, RENDER_EFFECT, RENDER_UI, RENDER_END };
