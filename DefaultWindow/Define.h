...
enum OBJID { OBJ_BOX, OBJ_ROPE, OBJ_CHEST, OBJ_HOLDOBJ, OBJ_OBSTACLE, OBJ_ITEM, OBJ_MONSTER, OBJ_PLAYER, OBJ_LAVA, OBJ_BOMB, OBJ_UI, OBJ_END };
enum RENDERID { RENDER_BACKGROUND, RENDER_GAMEOBJECT, RENDER_HOLDOBJ, RENDER_TILE, RENDER_GHOST, RENDER_EFFECT, RENDER_UI, RENDER_END };
