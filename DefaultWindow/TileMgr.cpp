...
{
	HANDLE hFile = CreateFile(L"../Data/Tile4.dat",		// 파일 경로(이름을 포함)
...
{
	HANDLE hFile = CreateFile(L"../Data/Tile4.dat", GENERIC_READ, NULL, NULL, OPEN_EXISTING,	FILE_ATTRIBUTE_NORMAL, NULL);
